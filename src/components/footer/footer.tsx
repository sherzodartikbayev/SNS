...
const Footer = () => {
  ...
  return (
    <div
      className={`${styles.paddingX} ${styles.flexBetween} max-lg:flex-col gap-10 w-full h-auto py-10 bg-primary`}
    >
      <div
        className="max-lg:text-center flex-col w-[50%] max-sm:w-full"
      >
        <h1 className="font-inter text-white">Barcha huquqlar himoyalangan.</h1>
        <p className="font-inter text-white">@ {date} - Web-Pro.</p>
      </div>

      <div className={`${styles.flexCenter} w-[50%] max-sm:flex-col max-md:w-auto `}>
        <Button
